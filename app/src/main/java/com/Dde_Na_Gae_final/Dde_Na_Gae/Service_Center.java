...
import com.Dde_Na_Gae_final.Dde_Na_Gae.model.Article_Model;
...
public class Service_Center extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.service_center_list);
        recyclerView.setAdapter(new Service_Center.ServiceCenterRecyclerViewAdapter());
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        go_back = (ImageView)findViewById(R.id.img_back);
        ...
        writing = (Button) findViewById(R.id.go_service_center_writing);
        my_list = (Button) findViewById(R.id.my_service_center_list);

        writing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (user == null) {
                    Toast.makeText(Service_Center.this, "로그인한 회원만 이용할 수 있습니다!", Toast.LENGTH_SHORT).show();
                }else{
                    Intent intent = new Intent(getApplicationContext(), Service_Center_Writing.class);
    ...
    class ServiceCenterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
            ...
            return new Service_Center.ServiceCenterRecyclerViewAdapter.ServiceCenterActivityViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder, int position) {
            Service_Center.ServiceCenterRecyclerViewAdapter.ServiceCenterActivityViewHolder serviceCenterActivityViewHolder = ((Service_Center.ServiceCenterRecyclerViewAdapter.ServiceCenterActivityViewHolder)holder);
