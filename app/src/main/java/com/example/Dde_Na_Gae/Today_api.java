...
public class Today_api implements Runnable{
...
//            System.out.println(jsonData);
    ...
    public ArrayList<String> getToday_images() {
        return today_images;
    }

    public ArrayList<String> getToday_titles() {
        return today_titles;
    }

    public ArrayList<String> getToday_contentids() {
        return today_contentids;
    }
}
